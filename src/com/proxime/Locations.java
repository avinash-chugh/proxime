...
import com.proxime.repositories.LocationsRepository;
...
public class Locations extends Activity {
    ...
    private void initializeLocationsView() {
    ...
    private void hookUpEvents() {
        ...
        locationsView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                setResult(RESULT_OK, new Intent().putExtra("location", new Location(1,"office", 1.0, 1.0, 50)));
                finish();
            }
        });
    }
